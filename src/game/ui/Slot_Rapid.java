...
public class Slot_Rapid extends Slot{
	...
	public void renderUI(float x, float y){
		...
		Shape.square(x, y, 16, 16, Assets.TEXTURE_SLOT_RAPID);
	...
	public void renderCUI(float x, float y){
		...
		Shape.square(x, y, 32, 32, Assets.TEXTURE_SLOT_RAPID);
		Shape.number(durability, x - 17, y + 3, 16, 22, Assets.TEXTURE_NUM);
	}
	
	public void render3D(float x, float y, float rotation){
		Shape.squarer(x, y, 16, 16, 16, 0, 0, rotation, Assets.TEXTURE_SLOT_RAPID);
	}
